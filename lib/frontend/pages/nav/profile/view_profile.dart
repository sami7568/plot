...
class ViewProfile extends StatelessWidget {
  ...
  final String profilePicURL; final double wallet;

  const ViewProfile({Key key, this.sharedPrefData, this.profilePicURL, this.wallet}) : super(key: key);
  @override
        ...
        body: SingleChildScrollView(
          ...
          child:SafeArea(child: Column(
            ...
            children: [
              ...
              SizedBox(height: 10,),
              Text('Available Balance: \$${wallet.toInt()}',
                textAlign: TextAlign.center,
                overflow: TextOverflow.ellipsis,
                maxLines: 3,
                style: TextStyle(
