        ...
        child: Column(
          children: [
            ...
            RichText(
              ...
              text: TextSpan(
                children: <TextSpan>[
                  TextSpan(text: 'you have paid ',
                      style: TextStyle(
                      color: Colors.white,
                      fontSize: 20
                  )),
                  TextSpan(text: "\$${getPaypalAmount(totalCost)}", style: TextStyle(
                      color: Colors.green,
                      fontWeight: FontWeight.bold,
                      fontSize: 20
                  ),),
                  ...
                  TextSpan(text: "Paypal", style: TextStyle(
                      color: Colors.green,
                      fontWeight: FontWeight.bold,
                      fontSize: 20
                  ),),
            ...
            Row(children: [
              ...
              Ticket(radius: 15,
                  ...
                  child: Container(
                      ...
                      child: Row(
                        children: [
                          Text("\$${getPaypalAmount(allTicketLevelsAndPrices[ticketLevel])}", style: TextStyle(
                              fontSize: 16,
