...
class _CreatePaymentDetailsState extends State<CreatePaymentDetails> {
  ...
  Map makePaymentInfoObject (List paymentMethods, List paymentHandles){
    ...
    // 'Venmo', 'Zelle', 'PayPal','Cash App', 'Other1', 'Other2', 'Pay at Door']
    List paymentGateways = ['PayPal'];
  ...
  String validateField(String value, [bool email = false]) {
      ...
      body: SingleChildScrollView(
        ...
        child: Form(
          ...
          child: Column(
            ...
            children: <Widget>[
              ...
              Opacity(
                ...
                SizedBox(height: 5,),
                Text("provide your paypal details to receive payments", style: TextStyle(
                    fontSize: 16,
                    color:free ? Colors.grey : Colors.white
                ),),
                SizedBox(
                ...
                Container(
                  ...
                  Container(
                    ...
                    child: TextFormField(
                      ...
                      validator: (value) => validateField(value.trim().toString(),true),
                      ...
                      decoration: InputDecoration(
                          ...
                          fillColor: Colors.black,
                          labelStyle: TextStyle(color: Colors.white),
                          labelText: 'Associated Email',
                          hintText: 'Associated Email',
                          hintStyle: TextStyle(
                              color: Colors.grey
                          ),
                          errorStyle: TextStyle(
          ...
          SizedBox(height: 10,),
              ...
              RawMaterialButton(
                onPressed: () async {
                  // allowVenmo, allowZelle, allowPayPal, allowCashapp, allowOther1, allowOther2, payAtDoor
                  List<bool> paymentMethods = [allowPayPal];
                  // venmo, zelle, paypal,cashApp, otherPaymentMethod1, otherPaymentMethod2, payAtDoorDetails
                  List<String> paymentHandles = [paypal];
                  //
