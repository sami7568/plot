...
import 'package:plots/wallet_screen.dar.dart';
...
class _JoinOrCreatePlotState extends State<JoinOrCreatePlot> {
  ...
  Future getWallet() async {
    await walletRef.doc(widget.sharedPrefData.authID).get().then((value) {
      if(value.exists){
        wallet = value.data()['total'];
      }else {
        wallet = 0.0;
      }
    });
  ...
  Widget build(BuildContext context) {
      ...
      children:[
          SafeArea(
            child: Row(children: [
              ...
              //   child: IconButton(
              //     icon: Icon(Icons.markunread_mailbox, color: Colors.white, size: 35,),
              //     onPressed: (){
              //       Get.to(() => WalletScreen());
              //     },
              //   ),
    ...
    Stack(children: [
      ...
      Align(alignment: Alignment.bottomRight, child: Container(
        ...
        Text("Available Balance: \$${wallet.toInt()}", style: TextStyle(fontSize:27),),
